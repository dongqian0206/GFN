...
def main():
    ...
    for step in range(1, args.num_steps + 1):
        ...
        log_PF_edge_flow = log_flowF + log_PF_sa
        ...
        log_PB_edge_flow = log_flowB * (1 - finishes) + log_rewards * finishes + log_PB_sa

        loss = (log_PF_edge_flow - log_PB_edge_flow).pow(2).mean()
