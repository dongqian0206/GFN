...
def get_train_args():
    parser = argparse.ArgumentParser(description='DB-augment-based GFlowNets for hypergrid environments')
    parser.add_argument(
...
def main():
    ...
    exp_name = 'db_augment_{}_{}_{}_{}_{}_{}_{}'.format(
    ...
    for step in range(1, args.num_steps + 1):
        ...
        while torch.any(~dones):
            ...
            for c, a, t in zip(child_states, actions, terminates.float()):
                ...
                batches += [[p.view(1, -1), a.view(1, -1)] + [c.view(1, -1), lr.view(-1), t.view(-1)] for p, a in zip(ps, pa)]
